    ...
    return (
        <>
            <section className="max-w-screen-xl mx-auto">
                <div
                    className="grid items-center grid-cols-3 my-20 rounded-3xl"
                    style={{
                ...
                >
                    <div className="col-span-1 px-5 py-10">
                        <img
                            ...
                            src="https://res.cloudinary.com/dnsekavtx/image/upload/v1730561234/KV_CTA_lu0uyu.svg"
                            alt=""
                        />
                    </div>
                    <div className="col-span-2 space-y-4 text-white">
                        ...
                        <p className="w-[65%]">
                            Never worry about losing more than your investment.
                            Our Negative Balance Protection resets your account
                            to zero if it goes negative, keeping your risk
                            limited and your trading safe.
                        </p>
                    </div>
                </div>
            </section>
